    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                <Newchessboard chessboardSize={boardSize} FEN={posFEN} theoryMoves={posMoves} moveCounter={moveCounter} moveListUpdate={setMoveList} />
                <div>
                    <Button onClick={() => {
                    ...
                    <Button onClick={() => {
                        ...
                        setposMoves(`1. d4 Nc6 2. Bf4 Nxd4 3. Qxd4 a5 4. e4 a4 5. Nf3 Nh6 6. Nc3 f6 7. Bxh6 gxh6 8.
...
Kh7 53. Kh5 Kh8 54. g6 Kg8 55. Kg5 Kh8 56. Rf8`)
            ...
            <div style={{
                ...
                Move history
                <br></br>
                <Movelistcanvas moveList={moveList} currentCounter={moveCounter} changeCounter={setMoveCounter} />
