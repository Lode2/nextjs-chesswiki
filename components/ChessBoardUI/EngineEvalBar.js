...
export default function EngineEvalBar(props) {
    ...
    return (
        <div style={{ position: 'relative', height: '100%' }}>
            <div style={{ height: whiteHeight + '%', backgroundColor: 'white', width: '100%', top: '0', transition: 'height 0.5s ease' }}></div>
            <div style={{ height: 100 - whiteHeight + '%', backgroundColor: 'black', width: '100%', bottom: '0', transition: 'height 0.5s ease' }}></div>
